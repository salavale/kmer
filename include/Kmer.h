...
public:
    ...
    /**
     * @brief Overloading of the assignment operator for Kmer class.
     * Modifier method
     * @param orig the Kmer object used as source for the assignment. Input
     * parameter
     * @return A reference to this object
     */    
    Kmer& operator=(const Kmer &orig);
