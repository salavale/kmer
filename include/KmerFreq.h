...
public:
    ...
    /**
     * @brief Overloading of the assignment operator for KmerFreq class.
     * Modifier method
     * @param orig the KmerFreq object used as source for the assignment. Input
     * parameter
     * @return A reference to this object
     */
    KmerFreq& operator=(const KmerFreq &orig);
